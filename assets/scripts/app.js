...
// if (randomNumber > 0.5 && randomNumber1 > 0.5) {
//   console.log('Both random numbers are graeter than 0.5');
// } else {
//   console.log('Both random numbers are NOT greater than 0.5 BOZO');
// }
